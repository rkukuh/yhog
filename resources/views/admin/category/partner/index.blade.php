                    ...
                    <tr class="level-1">
                        ...
                        <td class="text-right">
                            @component('common.datalist.button-edit')
                                @slot('text', '')
                                @slot('route', route('category-partner.edit', [
                                                        $categoryLv1,
                                                        'page' => $_GET['page'] ?? 1
                                                     ]
                                               )
                            ...
                            @component('common.datalist.button-remove')
                                @slot('text', '')
                                @slot('route', route('category-partner.destroy', $categoryLv1))
                            @endcomponent
                        </td>
                    </tr>
                    @foreach ($categoryLv1->childs as $categoryLv2)
                        <tr class="level-2">
                            ...
                            <td class="text-right">
                                ...
                                @component('common.datalist.button-remove')
                                    @slot('text', '')
                                    @slot('route', route('category-partner.destroy', $categoryLv2))
                                @endcomponent
                            </td>
                        </tr>
                        @foreach ($categoryLv2->childs as $categoryLv3)
                            <tr class="level-3">
                                ...
                                <td class="text-right">
                                    ...
                                    @component('common.datalist.button-remove')
                                        @slot('text', '')
                                        @slot('route', route('category-partner.destroy', $categoryLv3))
                                    @endcomponent
                                </td>
                            </tr>
                        @endforeach
