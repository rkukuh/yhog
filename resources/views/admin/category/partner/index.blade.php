...
@section('content-title')
    PARTNER CATEGORY <small>of Partner</small>
@endsection

@section('content-alt-header', 'Partner Category List')
                    ...
                    <tr class="level-1">
                        ...
                        <td class="text-right">
                            @component('common.datalist.button-edit')
                                @slot('text', '')
                                @slot('route', route('admin.category-partner.edit', [
                                                        $categoryLv1,
                                                        'page' => $_GET['page'] ?? 1
                                                     ]
                                               )
                            ...
                            @component('common.datalist.button-remove')
                                @slot('text', '')
                                @slot('route', route('admin.category-partner.destroy', $categoryLv1))
                            @endcomponent
                        </td>
                    </tr>
                    @foreach ($categoryLv1->childs as $categoryLv2)
                        <tr class="level-2">
                            ...
                            <td class="text-right">
                                ...
                                @component('common.datalist.button-remove')
                                    @slot('text', '')
                                    @slot('route', route('admin.category-partner.destroy', $categoryLv2))
                                @endcomponent
                            </td>
                        </tr>
                        @foreach ($categoryLv2->childs as $categoryLv3)
                            <tr class="level-3">
                                ...
                                <td class="text-right">
                                    ...
                                    @component('common.datalist.button-remove')
                                        @slot('text', '')
                                        @slot('route', route('admin.category-partner.destroy', $categoryLv3))
                                    @endcomponent
                                </td>
                            </tr>
                        @endforeach
...
@section('content-alt-form')
    @include('admin.category.partner._form')
@endsection